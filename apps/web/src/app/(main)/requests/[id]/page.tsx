...
export default async function RequestDetailPage({
  ...
  const isProfileComplete = Boolean(
    profile && profile.blood_group && user?.phone,
  );
                    ...
                    <div className="space-y-2.5 text-center pt-1">
                      ...
                      <Link href={`/login?redirect=/requests/${id}`}>
                        <Button
                          ...
                          variant="outline"
                          className="w-full border-red-300 text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/40"
                        >
                          Login to Donate
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        ...
                        location, and contact phone number before offering to
                        donate.
                      </p>

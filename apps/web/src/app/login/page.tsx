  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4">
      ...
      <Card className="w-full max-w-md border-zinc-200 dark:border-zinc-800 shadow-lg">
        ...
        <CardContent>
          <Button
            className="w-full h-12 text-base font-medium bg-white text-zinc-900 hover:bg-zinc-50 border border-zinc-200 shadow-sm dark:bg-zinc-900 dark:text-zinc-50 dark:hover:bg-zinc-800 dark:border-zinc-700"
